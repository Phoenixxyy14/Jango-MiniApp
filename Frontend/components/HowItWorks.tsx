  ...
  return (
    <section className="mt-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
        <div
          className="p-6 rounded-2xl bg-[#0096c7] border border-[#0096c7] backdrop-blur-md cursor-pointer"
          data-aos="fade-up"
          data-aos-delay="120"
        >
          <div className="text-6xl font-extrabold text-white">01</div>
        ...
        <div
          ...
          data-aos-delay="160"
        >
          <div className="text-6xl font-extrabold text-white">02</div>
